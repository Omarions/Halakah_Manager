...
public class StudentController {
     ...
     */
    @GetMapping("/admin/students/student/delete")
    public String deleteCourse(@RequestParam(value = "id") int id, RedirectAttributes redirectAttrs) {
        studentService.delete(id);
        redirectAttrs.addFlashAttribute("message", "Student with ID( " + id + " ) was deleted successfully");
    ...
    public String saveStudent(@Valid Student student, BindingResult bindingResult, Model model) {
        ...
        if (bindingResult.hasErrors()) {
            ...
            return (student.getId() == 0) ? "admin/register-course" : "redirect:/admin/students/student?id=" + student.getId();
