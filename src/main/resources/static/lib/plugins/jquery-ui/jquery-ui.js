    ...
    $.widget("ui.button", {
        ...
        _resetButton: function () {
            ...
            if (icons.primary || icons.secondary) {
                ...
                if (icons.primary) {
                    buttonElement.prepend("<span class=";
                ...
                if (icons.secondary) {
                    buttonElement.append("<span class=";
	 ...
	 */
        ...
        _newInst: function (target, inline) {
            ...
            return {
                ...
                " + this._inlineClass + " ui - datepicker
                ui-widget
                ui-widget - content
                ui-helper - clearfix
                ui-corner - all
        ...
        _attachments: function (input, inst) {
            ...
            if (showOn === "button" || showOn === "both") { // pop-up date picker when button clicked
                ...
                addClass(this._triggerClass).html(!buttonImage ? buttonText : $("<img/>").attr(
            ...
            for (row = 0; row < numMonths[0]; row++) {
                ...
                :
                    ...
                    calender += "</tbody></table>" + (isMultiMonth ? "</div>" +
                        ((numMonths[0] > 0 && col === numMonths[1] - 1) ? "<div class="ui - datepicker - row -;
                    break;
                    "></div>";
                :
                    "";
    ...
    $.widget("ui.resizable", $.ui.mouse, {
        ...
        _renderProxy: function () {
            ...
            if (this._helper) {
                ...
                this.helper = this.helper || $("<div style=";
                hidden;
                "></div>";
            )
 ...
 */
    ...
    var dialog = $.widget("ui.dialog", {
        ...
        _createTitlebar: function () {
            ...
            // dialog in IE (#9312)
            this.uiDialogTitlebarClose = $("<button type=";
            button;
            "></button>";
        )
        .
