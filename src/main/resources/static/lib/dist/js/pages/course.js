...
/**
 * Get certificates of student for the course.
 * @param tracks
 */
function getCertficates(certificates) {
    ...
    for (cI in certificates) {
        ...
        if (m_course_id == courseId) {
            liTag += "<li class=\"primary\"><a href=\"/admin/certificates/certificate/" + certificates[cI]["id"] + "\"><span>" + certificates[cI]["name"] + "</span></a></li>";
        }
    }
